...
public class MainActivity extends ActionBarActivity {
    ...
    public void clickBackBtn(View v){
        Intent chatIntent = new Intent(getApplicationContext(), initialActivity.class);
        startActivity(chatIntent);
    }

    public void clickDrawBtn(View v){
        Intent chatIntent = new Intent(getApplicationContext(), drawActivity.class);
        startActivity(chatIntent);
    }
    ...
    private void setToolbar() {
        ...
        toolbar.setBackgroundDrawable(new ColorDrawable(0x00FFFFFF));
    ...
    private void setFragmentNavigationDrawer() {
        ...
        drawerFragment.setUp(R.id.frag, (DrawerLayout) findViewById(R.id.drawer_layout), toolbar);
    }
